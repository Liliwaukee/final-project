...
function cipher (){
  ...
  for(var z = 0; z <arrayPhrase.length; z++){
     if(arrayPhrase[z] == 1 || arrayPhrase[z] == 2 || arrayPhrase[z] == 3 || arrayPhrase[z] == 4 || arrayPhrase[z] == 5 || arrayPhrase[z] == 6 ||arrayPhrase[z] == 7 ||arrayPhrase[z] == 8 ||arrayPhrase[z] == 9 || arrayPhrase[z] === 0 || arrayPhrase[z] == " " ){
     return alert("No puedes ingresar números, ni espacios");
      }
  }
  ...
  return document.write("El texto cifrado es: " + textCipher);
...
function decipher (){
  ...
  var textCipher = arrayCipher.join("");
  return document.write("El texto descifrado es: " + textCipher);
